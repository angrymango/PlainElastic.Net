...
namespace PlainElastic.Net.Queries
{
	...
	public class Aggregations<T> : QueryBase<Aggregations<T>>
    {
		...
		/// <summary>
		/// Defines a single bucket of all the documents within the search execution context. This context is defined by the indices and the document types you抮e searching on, but is not influenced by the search query itself.
